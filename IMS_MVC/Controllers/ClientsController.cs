...
namespace IMS_MVC.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Descriptive,DistrictId")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Descriptive,DistrictId")] Client client)
        {
            if (ModelState.IsValid)
            {
